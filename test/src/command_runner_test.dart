...
import 'package:sibyl_toolkit/src/command_runner.dart';
...
void main() {
  group('SibylToolkitCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late SibylToolkitCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = SibylToolkitCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = SibylToolkitCommandRunner();
